...
<div class="flex gap-4">
	...
	<div class="space-y-2">
		<div class="flex items-baseline">
			<h1 class="font-medium text-sm captalize">{name}</h1>
			<span class="text-xs text-gray-600">{publishedTimeText}</span>
		</div>
		...
		<div class="flex items-center gap-5">
			...
			<button class="px-2 font-medium captalize py-0.5 text-xs rounded-full hover:bg-gray-200">
				reply</button
			>
		</div>
	</div>
